...
// Purpose: Create the background panel for the puzzle on the changes tab
...
public class ChangeBackground extends JPanel {
   ...
   public void paintComponent(Graphics comp) {
       ...
       Rectangle2D.Float bounds = new Rectangle2D.Float(Changes.game[0][0].getX(), Changes.game[0][0].getY(), Changes.game[0][0].getWidth(), Changes.game[0][0].getHeight());
